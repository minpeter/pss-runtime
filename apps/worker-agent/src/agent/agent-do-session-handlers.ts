...
export class AgentDoSessionHandlers {
  ...
  async eventStream(request: Request): Promise<Response> {
  ...
  async submit(body: unknown): Promise<Response> {
  ...
  async transcript(body: unknown): Promise<Response> {
    if (body === undefined) {
