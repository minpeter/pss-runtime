...
const CODEQL_V4 = "b96794f015dfd88f77b49b1c93e0fa7110f94c63";
...
describe("pinning: shipped workflows are fully SHA-pinned (VAL-SEC-038)", () => {
  ...
  it("the shipped CodeQL workflow pins init and analyze to v4.38.0", () => {
    ...
    expect(
      ...
      { ref: `github/codeql-action/init@${CODEQL_V4}`, comment: "v4.38.0" },
      { ref: `github/codeql-action/analyze@${CODEQL_V4}`, comment: "v4.38.0" },
    ]);
  });
