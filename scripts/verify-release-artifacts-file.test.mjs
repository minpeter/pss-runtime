...
describe("verifyReleaseArtifacts file declaration checks", () => {
  ...
  it("checks Node local helpers on the file declaration subpath", () => {
    ...
    expect(verifyReleaseArtifacts({ cwd, packages: ["runtime"] })).toEqual([
      ...
      "packages/runtime/dist/platform/file/index.d.ts: missing explicit file runtime export NodeFileExecutionHostOptions",
      "packages/runtime/dist/platform/file/index.d.ts: missing explicit file runtime export NodeFileThreadHostOptions",
      ...
      "packages/runtime/dist/platform/file/index.d.ts: missing explicit file runtime export createNodeFileExecutionHost",
      "packages/runtime/dist/platform/file/index.d.ts: missing explicit file runtime export createNodeFileScheduler",
      "packages/runtime/dist/platform/file/index.d.ts: missing explicit file runtime export createNodeFileThreadHost",
