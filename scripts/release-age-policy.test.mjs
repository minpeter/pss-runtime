...
patchedDependencies:
  '@oh-my-pi/hashline@18.1.5': patches/@oh-my-pi__hashline@18.1.5.patch
...
overrides:
  # attw relies on this exact TypeScript build's internal API; do not apply the workspace TypeScript override to it.
